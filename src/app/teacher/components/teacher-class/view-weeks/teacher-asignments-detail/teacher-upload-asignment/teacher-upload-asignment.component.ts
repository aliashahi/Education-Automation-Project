...
@Component({
  selector: 'EAP-teacher-upload-asignment',
  templateUrl: './teacher-upload-asignment.component.html',
  styleUrls: ['./teacher-upload-asignment.component.scss'],
})
export class TeacherUploadAsignmentComponent implements OnInit {
  loading = false;
  avatarUrl?: string;
